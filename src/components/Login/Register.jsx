...
const Register = () => {
    ...
    return (
        <form onSubmit={handleToRegister} className='mx-96 mt-24 items-center'>
            ...
            <div className='mb-4'>
                <h3>Name</h3>
                <input className='w-96 h-8 rounded-lg mt-2 pl-2' type="text" name="name" id="" required />
            </div>
            <div className='mb-4'>
                <h3>Email Address</h3>
                <input className='w-96 h-8 rounded-lg mt-2 pl-2' type="email" name="email" id="" required />
            </div>
            <div className='mb-4'>
                <h3>Password</h3>
                <input className='w-96 h-8 rounded-lg mt-2 pl-2' type="password" name="password" id="" required />
            </div>
            <div className='mb-4'>
                <h3>Photo URL</h3>
                <input className='w-96 h-8 rounded-lg mt-2 pl-2' type="text" name='photo' required />
            </div>
